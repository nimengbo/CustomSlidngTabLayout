...
import com.example.abner.dynamicfragment.R;
import com.example.abner.dynamicfragment.utils.DensityUtils;
...
public class CustomSlidingTabLayout extends HorizontalScrollView {
    ...
    //default text color
    private int dTextColor = 0;
    //selected text color
    private int sTextColor = 0;
    //Previous selected position
    private int mPreviousPos = 0;
    //text size
    private int mTextSize = 0;
    //text need bold
    private boolean mNeedBold = false;
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            getTextViews().get(mPreviousPos).setTextColor(dTextColor);
            getTextViews().get(position).setTextColor(sTextColor);
